...
class StoragesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create storage" do
    assert_difference("Storage.count") do
      post storages_url, params: { storage: { branch_id: @storage.branch_id, quantity: @storage.quantity } }
    end
  ...
  test "should update storage" do
    patch storage_url(@storage), params: { storage: { branch_id: @storage.branch_id, quantity: @storage.quantity } }
